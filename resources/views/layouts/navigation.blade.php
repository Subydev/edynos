        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
             ...
             <li class="{{ (Request::is('home') ? 'active' : '') }}">
                <a href="{{ url('home') }}"><i class="fa fa-tachometer"></i><span class="nav-label">Dashboard</span></a>
            </li>
            <li class="{{ (Request::is('minor') ? 'active' : '') }}">
                <a href="{{ route('minor') }}"><i class="fa fa-th-large"></i><span class="nav-label">Create</span></a>
            </li>
            <li class="{{ (Request::is('minor') ? 'active' : '') }}">
                <a href="{{ route('minor') }}"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">My Charts</span></a>
            </li>
            <li class="{{ (Request::is('minor') ? 'active' : '') }}">
                <a href="{{ route('minor') }}"><i class="fa fa-address-card-o"></i><span class="nav-label">Forums</span></a>
            </li>
            <li class="{{ (Request::is('minor') ? 'active' : '') }}">
                <a href="{{ route('minor') }}"><i class="fa fa-picture-o"></i> <span class="nav-label">Gallery</span></a>
            </li>
            <li class="{{ (Request::is('minor') ? 'active' : '') }}">
